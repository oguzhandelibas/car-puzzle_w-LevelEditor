        ...
        void Start()
        {
            for (int y = 0; y < gridSize.x; y++)
            {
                for (int x = 0; x < gridSize.y; x++)
                {
                    ...
                    if (x != 0 && x!= gridSize.x-1 && y == 0) // Alt kenar
                    {
                        var road = Instantiate(roadData.road_default, obj.transform.position, Quaternion.identity);
                        road.transform.position += Vector3.back * 3.45f;
                        road.transform.rotation = Quaternion.Euler(0, 90, 0);
                    }
                    else if (x != 0 && x != gridSize.x - 1 && y == gridSize.x - 1) // Üst kenar
                    {
                        var road = Instantiate(roadData.road_default, obj.transform.position, Quaternion.identity);
                        road.transform.position += Vector3.forward * 3.45f;
                        road.transform.rotation = Quaternion.Euler(0, 90, 0);
                    }
                    else if (y != 0 && y != gridSize.y - 1 && x == 0) // Sol kenar
                    {
                        var road = Instantiate(roadData.road_default, obj.transform.position, Quaternion.identity);
                        road.transform.position += Vector3.left * 3.45f;
                        road.transform.rotation = Quaternion.Euler(0, 0, 0);
                    }
                    else if (y != 0 && y != gridSize.y - 1 && x == gridSize.y - 1) // Sað kenar
                    {
                        var road = Instantiate(roadData.road_default, obj.transform.position, Quaternion.identity);
                    ...
                    {
                        var road1 = Instantiate(roadData.road_default, obj.transform.position, Quaternion.identity);
                        road1.transform.position += Vector3.left * 3.45f;
                        road1.transform.rotation = Quaternion.Euler(0, 0, 0);

                        var road2 = Instantiate(roadData.road_default, obj.transform.position, Quaternion.identity);
                    ...
                    else if (y == 0 && x == gridSize.y - 1) // (0,1) sað ve alt
                    {
                        var road1 = Instantiate(roadData.road_default, obj.transform.position, Quaternion.identity);
                    ...
                    else if (y == gridSize.x - 1 && x == 0) // (1,0) sol ve üst
                    {
                        var road1 = Instantiate(roadData.road_default, obj.transform.position, Quaternion.identity);
                        road1.transform.position += Vector3.left * 3.45f;
                        road1.transform.rotation = Quaternion.Euler(0, 0, 0);
                    ...
                    else if (y == gridSize.x - 1 && x == gridSize.y - 1) // (1,1) sað ve üst
                    {
                        var road1 = Instantiate(roadData.road_default, obj.transform.position, Quaternion.identity);
                        road1.transform.position += Vector3.right * 3.45f;
                        road1.transform.rotation = Quaternion.Euler(0, 0, 0);
